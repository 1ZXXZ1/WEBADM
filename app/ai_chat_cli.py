...
Environment variables:
  ...
  SAMBA_API_URL   — API base URL (default: https://127.0.0.1:8099)
"""
...
def main():
    ...
    parser.add_argument("--api-url",
                        default=os.environ.get("SAMBA_API_URL", "https://127.0.0.1:8099"),
                        help="API base URL (default: https://127.0.0.1:8099)")
